...
figma.ui.onmessage = async (msg) => {
    if (msg.type === 'import-nodes') {
        try {
            ...
            rootFrame.resize(Math.max(800, rootFrame.width), Math.max(600, rootFrame.height));
 ...
 * Create FRAME node
 */
function createFrameNode(nodeData, parent) {
    var _a;
    ...
    if (nodeData.absoluteBoundingBox) {
        ...
        frame.resize(nodeData.absoluteBoundingBox.width, nodeData.absoluteBoundingBox.height);
    }
    frame.opacity = (_a = nodeData.opacity) !== null && _a !== void 0 ? _a : 1;
...
async function createTextNode(nodeData, parent) {
    ...
    // Load font first
    const fontFamily = ((_a = nodeData.style) === null || _a === void 0 ? void 0 : _a.fontFamily) || 'Inter';
    const fontStyle = ((_b = nodeData.style) === null || _b === void 0 ? void 0 : _b.fontPostScriptName) || 'Regular';
    try {
    ...
    text.opacity = (_c = nodeData.opacity) !== null && _c !== void 0 ? _c : 1;
 ...
 */
async function createRectangleNode(nodeData, parent) {
    var _a;
    ...
    if (nodeData.absoluteBoundingBox) {
        ...
        rect.resize(nodeData.absoluteBoundingBox.width, nodeData.absoluteBoundingBox.height);
    }
    ...
    rect.opacity = (_a = nodeData.opacity) !== null && _a !== void 0 ? _a : 1;
 ...
 */
function convertFill(fillData) {
    var _a;
    if (fillData.type === 'SOLID') {
        return {
            type: 'SOLID',
            color: fillData.color || { r: 0, g: 0, b: 0 },
            opacity: (_a = fillData.opacity) !== null && _a !== void 0 ? _a : 1
        };
    }
